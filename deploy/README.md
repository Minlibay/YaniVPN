# Деплой панели на VPS (HTTP по IP) — устаревший вариант

> **Рекомендуемый способ** — Docker Compose с PostgreSQL и автоматическим
> HTTPS: см. [docker.md](docker.md). Этот вариант (systemd + SQLite, HTTP
> по голому IP) оставлен для истории и быстрых тестов.
